  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-lg rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl transition-all dark:border-slate-800 dark:bg-slate-900"
      >
        <button
          onClick={onClose}
        ...
        <div className="mb-5 flex items-center space-x-3 pr-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 truncate flex items-center space-x-1">
              <span className="shrink-0">{t('home.toolbar.offline_download_enhanced.files_count') ? '目标目录: ' : 'Save to: '}</span>
